...
const Sidebar = () => {
  return (
    <aside className="w-full lg:w-75 flex flex-col gap-4 shrink-0 lg:sticky lg:top-10 lg:self-start">

      <div className='flex lg:flex-col flex-col sm:flex-row gap-4 ' >

      {/* Profile Card */}
      <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 flex-1">
        <div className='relative' >

        <Image src = {coverImage} alt='cover-image' className="h-24 object-cover lg:object-fill" />
      ...
      {/* Stats Card */}
      <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 space-y-4 flex-1">
